...
const PRO_TRIAL_PRICE_ID = process.env.PRO_TRIAL_PRICE_ID || 'price_1U4NfJFrLrGfWhNdbzTwd3BA';
    ...
    await axios.post('https://api.brevo.com/v3/smtp/email', {
      ...
      htmlContent: `
        <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:600px;margin:auto;padding:32px;background:#fff">
          ...
          <p style="color:#6B6B64;margin-bottom:24px">Sauf résiliation de votre part, votre abonnement basculera automatiquement sur le plan <strong>Pro (89€/mois HT)</strong> et votre carte enregistrée sera débitée.</p>
        ...
        await axios.post('https://api.brevo.com/v3/smtp/email', {
          ...
          htmlContent: `
            <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:600px;margin:auto;padding:32px;background:#fff">
              ...
              <p style="color:#6B6B64;margin-bottom:24px">Sauf résiliation de votre part, votre abonnement basculera automatiquement sur le plan <strong>Pro (89€/mois HT)</strong> à la fin de l'accès test — votre carte enregistrée sera alors débitée. Vous pouvez résilier à tout moment depuis votre dashboard.</p>
        ...
        axios.post('https://api.brevo.com/v3/smtp/email', {
          ...
          htmlContent: `
            <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:600px;margin:auto;padding:32px;background:#fff">
              ...
              <p style="color:#6B6B64;margin-bottom:24px">Votre accès test Notelo est terminé et le passage au plan Pro (89€/mois HT) n'a pas pu être débité sur votre carte. Merci de mettre à jour votre moyen de paiement pour conserver l'accès à votre compte.</p>
