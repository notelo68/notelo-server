...
const PRO_TRIAL_PRICE_ID = process.env.PRO_TRIAL_PRICE_ID || 'price_1UFYW6FrLrGfWhNdFzYWZETS';
    ...
    await axios.post('https://api.brevo.com/v3/smtp/email', {
      ...
      htmlContent: `
        <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:600px;margin:auto;padding:32px;background:#fff">
          ...
          <p style="color:#6B6B64;margin-bottom:24px">Sauf résiliation de votre part, votre abonnement basculera automatiquement sur le plan <strong>Pro (99€/mois HT)</strong> et votre carte enregistrée sera débitée.</p>
...
app.post('/webhook/stripe', express.raw({ type: 'application/json' }), async (req, res) => {
  ...
  if (event.type === 'checkout.session.completed') {
        ...
        await axios.post('https://api.brevo.com/v3/smtp/email', {
          ...
          htmlContent: `
            <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:600px;margin:auto;padding:32px;background:#fff">
              ...
              <p style="color:#6B6B64;margin-bottom:24px">Sauf résiliation de votre part, votre abonnement basculera automatiquement sur le plan <strong>Pro (99€/mois HT)</strong> à la fin de l'accès test — votre carte enregistrée sera alors débitée. Vous pouvez résilier à tout moment depuis votre dashboard.</p>
    ...
    const planKey = amount <= 6900 ? 'starter' : amount <= 9900 ? 'pro' : 'business';
    const planLabels = {
      starter:  { name: 'Starter',  limit: '20 SMS/mois',   price: '69€/mois' },
      pro:      { name: 'Pro',      limit: '200 SMS/mois',  price: '99€/mois' },
      business: { name: 'Business', limit: '750 SMS/mois', price: '199€/mois' }
    };
        ...
        axios.post('https://api.brevo.com/v3/smtp/email', {
          ...
          htmlContent: `
            <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:600px;margin:auto;padding:32px;background:#fff">
              ...
              <p style="color:#6B6B64;margin-bottom:24px">Votre accès test Notelo est terminé et le passage au plan Pro (99€/mois HT) n'a pas pu être débité sur votre carte. Merci de mettre à jour votre moyen de paiement pour conserver l'accès à votre compte.</p>
